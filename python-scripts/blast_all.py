...
def main(inFile=None,db=None,eVal=None,out=None,thr=None,spl=None):
...
if __name__ == '__main__':
        ...
        print(vars(args))
        Main(inFile=args.i,db=args.db,eVal=args.evalue,out=args.out,thr=args.th,spl=args.fasta_spl)
