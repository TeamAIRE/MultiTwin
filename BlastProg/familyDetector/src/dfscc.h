...
void dfsCC( std::map<unsigned long long int,geneInfo>& genes, std::map<std::pair<unsigned long long int, unsigned long long int>, edgeValues>& edges, std::map<unsigned long long int, bool>& isVisited, unsigned short int minCov, unsigned short int mutual, std::string outputDir, unsigned short int verbose, unsigned short int Pident);
